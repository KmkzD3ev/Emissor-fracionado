...
public class ProdutosPedidoNFeAdapter extends RecyclerView.Adapter<ProdutosPedidoNFeAdapter.ViewHolder> {
    ...
    public ProdutosPedidoNFeAdapter(Context context, ArrayList<ProdutosPedidoDomain> elementos, DatabaseHelper bd) {
    ...
    public void excluirItem(String codigo, int position) {
        bd.deleteProdutoPedidoNFe(codigo);
