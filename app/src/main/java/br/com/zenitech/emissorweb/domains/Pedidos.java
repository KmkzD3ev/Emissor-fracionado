...
public class Pedidos {
    ...
    public Pedidos(String id, String situacao, String protocolo, String data, String hora, String valor_total, String data_protocolo, String hora_protocolo, String cpf_cliente, String forma_pagamento) {
        this.id = id;
