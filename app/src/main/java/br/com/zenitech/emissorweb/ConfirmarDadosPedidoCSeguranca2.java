...
public class ConfirmarDadosPedidoCSeguranca2 extends AppCompatActivity implements View.OnClickListener {
    // ATIVA O MODO TESTE
    ...
    ConfirmarDadosPedidoCSeguranca2 mActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contexto = ConfirmarDadosPedidoCSeguranca2.this;
        ...
        if (transmitindo != 0) {
            ...
            try {
                if (elementosItens.size() != 0) {
                    ...
                    String idsProdutosPedido = bd.getIdsProdutosPedido(pedidos.getId_pedido_temp()).replace(".", "");
                    String quantidadesProdutosPedido = bd.getQuantidadesProdutosPedido(pedidos.getId_pedido_temp()).replace(".", "");
                    String valorProdutosPedido = bd.getValorProdutosPedido(pedidos.getId_pedido_temp()).replace(".", "");
