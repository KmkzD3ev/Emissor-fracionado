...
public class DescricaoItensPedidoNFeAdapter extends RecyclerView.Adapter<DescricaoItensPedidoNFeAdapter.ViewHolder> {

    ClassAuxiliar aux;
    ArrayList<StatusPedidosNFE> elementos;

    public DescricaoItensPedidoNFeAdapter(ClassAuxiliar aux, ArrayList<StatusPedidosNFE> elementos) {
        this.aux = aux;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        //
        final StatusPedidosNFE item = elementos.get(position);
        ...
        holder.txtValDesc.setText("0,00");//aux.maskMoney(new BigDecimal(item.getDesconto())) | aux.maskMoney(new BigDecimal(produto.valor))
