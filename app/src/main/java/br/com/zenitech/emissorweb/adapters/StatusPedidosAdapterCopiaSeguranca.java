...
public class StatusPedidosAdapterCopiaSeguranca extends RecyclerView.Adapter<StatusPedidosAdapterCopiaSeguranca.ViewHolder> {

    private ClassAuxiliar aux;
    private Context context;
    private ArrayList<StatusPedidos> elementos;

    public StatusPedidosAdapterCopiaSeguranca(Context context, ArrayList<StatusPedidos> elementos) {
