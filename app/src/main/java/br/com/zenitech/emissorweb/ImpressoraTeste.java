...
public class ImpressoraTeste extends AppCompatActivity {
    ...
    private void dialog(final int iconResId, final String title, final String msg) {
        runOnUiThread(() -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(ImpressoraTeste.this);
    ...
    private void runTask(final PrinterRunnable r, final int msgResId) {
        final ProgressDialog dialog = new ProgressDialog(ImpressoraTeste.this);
    ...
    private void printNFCE(final String[] texto) {
        ...
        runTask((dialog, printer) -> {
            ...
            */
            ...
            String url = "http://www.set.rn.gov.br/nfce/qrcode?p=" + texto[6] + "|2|1|<identificador_csc>|<codigo_hash>";
            ...
            */
            ...
            Intent i = new Intent(ImpressoraTeste.this, Principal.class);
...
/*
                ...
                printer.setBarcode(Printer.ALIGN_CENTER, false, 2, Printer.HRI_NONE, 100);
                printer.printQRCode(4, 3, "http://www.zenitech.com.br");
                printer.feedPaper(38);
                */
                printer.flush();
            }, R.string.msg_printing_barcode);
